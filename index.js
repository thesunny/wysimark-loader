 ...
 *
 * TODO:
 * Probably should use the same Component as the editor itself.
 */
...
function Placeholder({ minHeight, spinner, }) {
    return (React__default['default'].createElement($Container, { style: { height: minHeight } }, spinner ? (React__default['default'].createElement($Spinner, null,
